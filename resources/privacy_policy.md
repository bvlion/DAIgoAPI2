...
「1.取得する情報と利用目的」に基づき取得された情報のうち、本アプリの機能提供に必要な情報は、当方が管理するサーバーに転送され、目的の範囲内でのみ使用されます。

また、本アプリの利用情報（Firebase Analytics）及び本アプリで発生したクラッシュ情報（Firebase Crashlytics）は、Googleが提供するFirebaseへ送信され、それぞれの機能の提供のために利用されます。
